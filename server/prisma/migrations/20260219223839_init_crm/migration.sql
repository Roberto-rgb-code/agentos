...
-- CreateEnum
CREATE TYPE "LeadEventType" AS ENUM ('CONTACTED', 'QUALIFIED', 'CONVERTED', 'PURCHASE', 'REGISTRATION', 'RESERVATION');
...
-- CreateIndex
CREATE UNIQUE INDEX "integration_api_keys_key_key" ON "integration_api_keys"("key");

-- CreateIndex
CREATE INDEX "integration_api_keys_key_idx" ON "integration_api_keys"("key");

-- CreateIndex
CREATE INDEX "integration_api_keys_user_id_idx" ON "integration_api_keys"("user_id");
...
-- CreateIndex
CREATE INDEX "whatsapp_messages_wa_from_idx" ON "whatsapp_messages"("wa_from");

-- CreateIndex
CREATE INDEX "whatsapp_messages_received_at_idx" ON "whatsapp_messages"("received_at");
...
-- AddForeignKey
ALTER TABLE "integration_api_keys" ADD CONSTRAINT "integration_api_keys_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "leads" ADD CONSTRAINT "leads_owner_user_id_fkey" FOREIGN KEY ("owner_user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;
